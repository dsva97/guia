        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container mt-n10">
                    <div class="card mb-4">
                        <div class="card-header">Devolver Asignaciones
...
<script>
    ...
    $(function() {
        ...
        tblAsig = $('#tblAsig').DataTable({
            ajax: "server/ajax.php?controller=asignaciones&action=populateNoDevuelto"
        });
    ...
    function fncVerificarDevolverA(nIdRegistro) {
        if (confirm('Se devolverá la asignación y no podrá deshacerse. ¿ Esta seguro de continuar ?')) {
            ...
            fncDevolverA(jsnData, function(aryData) {
    ...
    function fncDevolverA(jsnData, fncCallback) {
        $.ajax({
            type: 'post',
            url: "server/ajax.php?controller=asignaciones&action=devolver",
            data: jsnData,
            dataType: 'json',
            beforeSend: function() {
                fncMostrarLoader();
