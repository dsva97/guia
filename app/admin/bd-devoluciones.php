        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container mt-n10">
                    <div class="card mb-4">
                        <div class="card-header">Devoluciones
        ...
        <div class="modal-content">
            <form>
                <div class="modal-header">
                    <h5 class="modal-title" id="formCEA">Ver Devolucion</h5>
...
<script>
    ...
    $(function() {
        ...
        tblAsig = $('#tblAsig').DataTable({
            ajax: "server/ajax.php?controller=devoluciones&action=populate"
        });
        ...
        fncBuscarRegistroA(jsnData, function(aryResponse) {
            ...
            if (aryResponse.success) {
                ...
                if(sOpcion == 'editar'){
                    ...
                    fncViewForm("#formCEA" , "Ver Devolucion");
                }
    ...
    function fncBuscarRegistroA(jsnData, fncCallback) {
        $.ajax({
            type: 'post',
            dataType: 'json',
            url: "server/ajax.php?controller=devoluciones&action=mostrar",
            data: jsnData,
            beforeSend: function() {
                fncMostrarLoader();
            },
    ...
    function fncEliminarA(jsnData, fncCallback) {
        $.ajax({
            type: 'post',
            url: "server/ajax.php?controller=devoluciones&action=eliminar",
            data: jsnData,
            dataType: 'json',
            beforeSend: function() {
                fncMostrarLoader();
